...
describe('nameInverter', function() {
  ...
  it(`should return a last-name, first-name, when pased a first and last-name`, function() {
  ...
  it(`should return honorific honorific first-name when passed honorific first-name`, function() {
  ...
  it(`should throw an Error when name is undefined`, function() {
    ...
    assert.throws(() => nameInverter(input), Error);
  });
